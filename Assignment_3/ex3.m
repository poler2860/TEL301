...
f_axis2=(-Fs2/2:Fs2/N2:(Fs2/2)-(Fs2/N2));
subplot(2,1,2);
stem(f_axis2,Xf2);
xlabel('Frequency(Hz)','Fontsize',11);
ylabel('Amplitude', 'Fontsize',11);
...
subplot(2,1,2);
Xf2_filter2=fftshift(fft(Xn2_filter)); 
stem(f_axis2,Xf2_filter2);
xlabel('Frequency(Hz)','Fontsize',11);
ylabel('Amplitude', 'Fontsize',11);
title('The Fourier transform of x(t)=1+cos(t)+cos(5t) with 16th order filter','Fontsize',11,'FontWeight','bold');

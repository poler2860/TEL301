...
sgtitle('Hamming');
subplot(1,2,1);
plot(linspace(0,1,length(hamw1)),20*log10(abs(H_hamming1)),'LineWidth',2);
grid on;
title('Filters Frequency Response');
xlabel('Normalize Frequency');
ylabel('Amplitude (dB)');
subplot(1,2,2);
plot(linspace(0,1,length(hamw2)), 20*log10(abs(H_hamming2)),'LineWidth',2);
grid on;
title('Filters Frequency Response');
xlabel('Normalize Frequency');
ylabel('Amplitude (dB)');
...
sgtitle('Hanning');
subplot(1,2,1);
plot(linspace(0,1,length(hanw1)), 20*log10(abs(H_hanning1)),'LineWidth',2);
grid on;
title('Filters Frequency Response');
xlabel('Normalize Frequency');
ylabel('Magnitude (dB)');
subplot(1,2,2);
plot(linspace(0,1,length(hanw2)),20*log10(abs(H_hanning2)),'LineWidth',2);
grid on;
title('Filters Frequency Response');
xlabel('Normalize Frequency');
ylabel('Magnitude (dB)');
...
grid on;
title('X with filter hamming N = 21');
xlabel('Frequency (Hz)');
ylabel('Xfiltered(f)');
subplot(3,1,3);
plot(F, abs(spectrum_filteredHam2),'LineWidth',2);
grid on;
title('X with filter hanning N = 41');
xlabel('Frequency (Hz)');
ylabel('Xfiltered(f)');
...
grid on;
title('X with filter hanning N = 21');
xlabel('Frequency (Hz)'); ylabel('|X(f)|');
subplot(3,1,3);
